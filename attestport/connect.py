"""Native cognis-connect emit for attestport — forward findings to any platform.

Maps attestport's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    attestport ... --format json | attestport-emit --to stix
    attestport-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
